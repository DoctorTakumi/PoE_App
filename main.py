...
# If the user is in Act 2, ask for the quest
    ...
    if quest_input == 1 or quest_input == 2 or quest_input == 3:
        ...
        # calling the char_check function
        char_check = f.get_valid_char_check()
        if char_check == "yes" or char_check == "y":
            print ("You have to do it for the ascendancy!")
        else:
            print ("You can skip it!")
    else:
        print (f"You have to do {q.quests_act2[quest_input]}.")
...
## napraviti loop nakon odgovora za odredjeni quest, da program pita jel to to ili ti treba jos neki odgovor!
## negdje dodati: ako ti treba vise info, pogledaj na...related poe URL
## ideja za split:
## speed-run questovi / skip bosseva / ...